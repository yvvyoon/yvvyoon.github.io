---
title: 'PyPI mirror 서버 구축하기 with devpi-server'
date: 2019-12-13 18:00:00 -0400
categories: Python
---
...
`devpi-server`의 기본 포트는 3141이다. 포트에 대한 귀여운 유래가 있는데, 공식 문서에 따르면 원주율 PI(**_3.141_**592...)에서 따왔다고 한다. `devpi`에 `PI`가 들어있으니까.
